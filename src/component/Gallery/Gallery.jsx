    ...
    return (
        <div className='my-20 container mx-auto'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-4 justify-center items-center my-16 gap-5 place-items-center'>
                <div >
                    <img className='rounded-lg transition-all hover:scale-110'  src={images1} alt="" />
                </div>
                <div >
                    <img className='rounded-lg transition-all hover:scale-110'  src={images2} alt="" />
                </div>
                <div >
                    <img className='rounded-lg transition-all hover:scale-110'  src={images3} alt="" />
                </div>
                <div >
                    <img className='rounded-lg transition-all hover:scale-110'   src={images4} alt="" />
                </div>
